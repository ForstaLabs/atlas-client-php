...
class UserAuthentication implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserAuthentication';
     ...
     * Sets authtoken
     *
     * @param string|null $authtoken For code-based auth. Format: orgslug:userslug:sentcode
     *
     * @return $this
     */
     ...
     * Sets userauthtoken
     *
     * @param string|null $userauthtoken For token-based auth.
     *
     * @return $this
     */
     ...
     * Sets jwtproxy
     *
     * @param string|null $jwtproxy JWT token from trusted foreign source
     *
     * @return $this
     */
     ...
     * Sets fq_tag
     *
     * @param string|null $fq_tag For password-based auth. Format: @userslug:orgslug
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string|null $password For password-based auth.
     *
     * @return $this
     */
     ...
     * Sets otp
     *
     * @param string|null $otp For multifactor auth.
     *
     * @return $this
     */
