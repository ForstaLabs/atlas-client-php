...
/**
 * EphemeralUserViewPostResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EphemeralUserViewPostResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EphemeralUserViewPostResponse';
    ...
    public function setJwt($jwt)
    {
        ...
        if ((mb_strlen($jwt) < 1)) {
            throw new \InvalidArgumentException('invalid length for $jwt when calling EphemeralUserViewPostResponse., must be bigger than or equal to 1.');
        }
