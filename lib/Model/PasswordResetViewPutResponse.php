...
/**
 * PasswordResetViewPutResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PasswordResetViewPutResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PasswordResetViewPutResponse';
    ...
    public function setJwt($jwt)
    {
        ...
        if ((mb_strlen($jwt) < 1)) {
            throw new \InvalidArgumentException('invalid length for $jwt when calling PasswordResetViewPutResponse., must be bigger than or equal to 1.');
        }
